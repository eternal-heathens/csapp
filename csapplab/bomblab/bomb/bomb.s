...
0000000000401062 <phase_5>:
  ...
  401067:	48 89 fb             	mov    %rdi,%rbx  !# 第一个参数放到rbx
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
  401078:	31 c0                	xor    %eax,%eax
  40107a:	e8 9c 02 00 00       	call   40131b <string_length> 
  40107f:	83 f8 06             	cmp    $0x6,%eax !# 校验长度是否为6
  401082:	74 4e                	je     4010d2 <phase_5+0x70>
  401084:	e8 b1 03 00 00       	call   40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx   !# rbx补0放到ecx
  40108f:	88 0c 24             	mov    %cl,(%rsp) !# 取ecx后8位
  401092:	48 8b 14 24          	mov    (%rsp),%rdx !# 放到rdx
  401096:	83 e2 0f             	and    $0xf,%edx  !#  保留后四位
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx  
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1) !#后8位放到 0x10+%rsp
  ...
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax  !# 校eax清0
...
00000000004010f4 <phase_6>:
  ...
  40111e:	83 f8 05             	cmp    $0x5,%eax !# 第n个参数是不是小于5，搭配上面的--，即入参是否都小于等于6
  401121:	76 05                	jbe    401128 <phase_6+0x34>
  401123:	e8 12 03 00 00       	call   40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d  !# r12d从1到6，相当于检查6个参数，等于6跳到401153
  401130:	74 21                	je     401153 <phase_6+0x5f>
  401132:	44 89 e3             	mov    %r12d,%ebx
  401135:	48 63 c3             	movslq %ebx,%rax
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)
  40113e:	75 05                	jne    401145 <phase_6+0x51> !# 每一个数与后面的数进行比较，相等就爆炸
  401140:	e8 f5 02 00 00       	call   40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx
  401148:	83 fb 05             	cmp    $0x5,%ebx !# 二次检查，如果大于5则爆炸
  40114b:	7e e8                	jle    401135 <phase_6+0x41>
  40114d:	49 83 c5 04          	add    $0x4,%r13
  401151:	eb c1                	jmp    401114 <phase_6+0x20>
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi !# 执行完六个参数的遍历
  401158:	4c 89 f0             	mov    %r14,%rax
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx
  401160:	89 ca                	mov    %ecx,%edx
  401162:	2b 10                	sub    (%rax),%edx  !#7-第n个参数
  401164:	89 10                	mov    %edx,(%rax) !#每个参数都 = 7-自己
  ...
  40117d:	39 c8                	cmp    %ecx,%eax !#寻找到参数对应的链表地址%rdx即寻找 第 7 - int个链表元素 
  40117f:	75 f5                	jne    401176 <phase_6+0x82>
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx  !# 设置基地址
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) !#从%rsp+0x20开始，每次%rsi,2 等于加8个字节 ，将0x6032d0开始每个元素按顺序放置
  40118d:	48 83 c6 04          	add    $0x4,%rsi  
  401191:	48 83 fe 18          	cmp    $0x18,%rsi !# 循环6次
  401195:	74 14                	je     4011ab <phase_6+0xb7> 
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx   !# 从rsp 重新开始，读取每个参数
  40119a:	83 f9 01             	cmp    $0x1,%ecx  !如果值小于1
  ...
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi !# 链表最后node+1地址
  4011ba:	48 89 d9             	mov    %rbx,%rcx
  4011bd:	48 8b 10             	mov    (%rax),%rdx 
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx) !# 不是很懂有啥用，rcx会是前一个node，next指向rdx？
  4011c4:	48 83 c0 08          	add    $0x8,%rax
  4011c8:	48 39 f0             	cmp    %rsi,%rax
  4011cb:	74 05                	je     4011d2 <phase_6+0xde> !# rdx指向最后一个node
  ...
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa> !# 是否为降序排序
...
0000000000401204 <fun7>:
  ...
  401211:	7e 0d                	jle    401220 <fun7+0x1c> !# 大于等于则跳转到401220
  401213:	48 8b 7f 08          	mov    0x8(%rdi),%rdi
  401217:	e8 e8 ff ff ff       	call   401204 <fun7>
  40121c:	01 c0                	add    %eax,%eax !#rax = 2rax 
  40121e:	eb 1d                	jmp    40123d <fun7+0x39>
  401220:	b8 00 00 00 00       	mov    $0x0,%eax
  401225:	39 f2                	cmp    %esi,%edx !#rax = 0
...
0000000000401242 <secret_phase>:
  ...
  40125a:	48 89 c3             	mov    %rax,%rbx !# 值保存到rbx
  40125d:	8d 40 ff             	lea    -0x1(%rax),%eax
  401260:	3d e8 03 00 00       	cmp    $0x3e8,%eax
  401265:	76 05                	jbe    40126c <secret_phase+0x2a>
  401267:	e8 ce 01 00 00       	call   40143a <explode_bomb>
  40126c:	89 de                	mov    %ebx,%esi !# 输入的值由rbx值保存到rsi
  40126e:	bf f0 30 60 00       	mov    $0x6030f0,%edi !# rdi 保存二叉树的第一个地址
